-- =====================================================
-- PAYMENTS TABLE DEPLOYMENT FOR SUPABASE CLOUD
-- =====================================================
-- Run this SQL in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/fxqzihpsasuerpfjzwfr/sql/new
-- =====================================================
...
-- Add payment_id column to registrations table if it doesn't exist
DO $$ 
BEGIN
...
-- DEPLOYMENT COMPLETE!
-- =====================================================
-- After running this SQL, your payment system is fully deployed.
-- Test it by going to an event and clicking "Buy Ticket"
-- =====================================================
